...
public class UserResource implements Serializable{
    ...
    public Response getUser(@QueryParam("id") Long id) throws JAXBException, IOException {
        Person test = new Person("User Kurzbeschreibung", "User Langbeschreibung", new String[]{"Userziel1", "Userziel2"}, "http://localhost:8080/studfileserver/projectlogos/Projektlogo.png", "TestNutzer", "testemail@test.de", "testpw");
    ...
    public Response getList() {
        Person test1 = new Person("User1 Kurzbeschreibung", "User1 Langbeschreibung", new String[]{"Userziel11", "Userziel12"}, "http://localhost:8080/studfileserver/projectlogos/Projektlogo.png", "TestNutzer1", "testemail1@test.de", "testpw");
        Person test2 = new Person("User2 Kurzbeschreibung", "User2 Langbeschreibung", new String[]{"Userziel21", "Userziel22"}, "http://localhost:8080/studfileserver/projectlogos/Projektlogo.png", "TestNutzer2", "testemail2@test.de", "testpw");
    ...
    public Response create(String user) {
        ...
        try {
            ...
            String benutzername = jsonNode.get("benutzername").asText();
            String email = jsonNode.get("email").asText();
            String passwort = jsonNode.get("passwort").asText();
            JsonNode ziele = jsonNode.get("ziele");
            String[] zielArray = mapper.readValue(ziele, String[].class);
            userDao.create(new Person(kurzbeschreibung, langbeschreibung, zielArray, bild, benutzername, email, passwort));
