...
public class CommentResource implements Serializable {
    ...
    public Response getComment(@QueryParam("id") Long id) throws JAXBException, IOException {
        Comment test = new Comment(null, "Ich fasse es nicht wie geil das ist", null);
    ...
    public Response getList(@QueryParam("id") Long id) {
        Comment test1 = new Comment(null, "Test Kommentar1 Klasse Dude", null);
        Comment test2 = new Comment(null, "Test Kommentar2 Super Klasse Dude", null);
    ...
    public Response create(String comment) {
        ...
        try {
            ...
            commentDao.create(new Comment(null, kommentar, null));
